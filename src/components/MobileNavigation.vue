  ...
  <nav class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-xl z-50">
    <div class="grid grid-cols-4 gap-3 p-4">
      ...
      <button
        ...
        class="flex flex-col items-center justify-center py-3 px-2 rounded-lg hover:bg-gray-100 active:bg-gray-200 transition-colors min-h-touch"
      >
        <svg class="w-6 h-6 text-secondary-600 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <svg class="w-6 h-6 text-warning-600 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <button
        ...
        class="flex flex-col items-center justify-center py-3 px-2 rounded-lg hover:bg-gray-100 active:bg-gray-200 transition-colors min-h-touch"
      >
        <svg class="w-6 h-6 text-accent-600 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="text-center pb-2 px-4">
      <p class="text-[10px] text-gray-400">左右滑動切換題目</p>
    </div>
  </nav>
</template>
