...
const { loading, error, loadResourcesMap, getCertificationById, getSubjectById, getResourcesByType, getCategoryById, getLevelById } = useResourcesMap()
  ...
  <div class="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 py-12 px-4">
    ...
    <div v-if="loading" class="flex items-center justify-center min-h-screen">
      <div class="text-center">
        ...
        <p class="text-gray-600 text-lg">載入資源列表...</p>
      </div>
    </div>
    ...
    <!-- Main Content -->
    <div v-else-if="resource && subject && certification" class="max-w-6xl mx-auto">
      <!-- Header -->
      <div class="mb-8">
        ...
        <div class="text-center mb-8">
          ...
          <div v-if="!isNewStructure" class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-4 flex-wrap">
          ...
          <div v-else class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-4 flex-wrap">
            ...
            <span class="hover:text-primary-600 cursor-pointer" @click="goBack">講義區</span>
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
            <span class="font-semibold text-gray-900">{{ currentMetadata.title }}</span>
          ...
          <p class="text-lg text-gray-600">{{ resource.description }}</p>
        </div>
        ...
        <div class="max-w-2xl mx-auto">
          <div class="relative">
            ...
            />
            <svg class="w-6 h-6 text-gray-400 absolute right-4 top-1/2 transform -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="space-y-4">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0"
              ...
              <svg class="w-6 h-6"
                ...
                <path v-if="resourceType === 'handouts'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                <path v-else-if="resourceType === 'formulas'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                <path v-else-if="resourceType === 'diagrams'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM14 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 17a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1v-2zM14 17a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1h-4a1 1 0 01-1-1v-2z" />
        ...
        <div v-if="filteredItems.length === 0" class="text-center py-12">
          ...
          <p class="text-gray-600 text-lg">沒有找到符合的資源</p>
          <button @click="searchQuery = ''" class="mt-4 text-primary-600 hover:text-primary-700 font-semibold">
            清除搜尋
          </button>
        </div>
      </div>
