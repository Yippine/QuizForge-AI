  ...
  <div class="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 py-12 px-4">
    ...
    <div v-if="loading" class="flex items-center justify-center min-h-screen">
      <div class="text-center">
        ...
        <p class="text-gray-600 text-lg">載入認證資料...</p>
      </div>
    </div>
    ...
    <!-- Main Content -->
    <div v-else-if="certification && ipasCategory" class="max-w-6xl mx-auto">
      <!-- Header -->
      <div class="mb-8">
        ...
        <div class="text-center">
          ...
          <div class="flex items-center justify-center gap-2 text-sm text-gray-600 mb-4">
            <span class="hover:text-primary-600 cursor-pointer" @click="goBack">{{ ipasCategory.name }}</span>
          ...
          <h1 class="text-4xl font-bold text-gray-900 mb-4">{{ certification.name }}</h1>
          <p class="text-lg text-gray-600">{{ certification.description }}</p>
        </div>
      </div>
