 ...
 * Use CertificationView.vue instead. Old routes now redirect to new hierarchy.
...
const { loading, error, loadResourcesMap, getCertificationById } = useResourcesMap()
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <div class="flex items-start gap-4 mb-6">
            ...
            <div>
              <div class="text-sm text-secondary-600 font-semibold mb-1">
                {{ subject.code }}
              </div>
