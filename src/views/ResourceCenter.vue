  ...
  <div class="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 py-12 px-4">
    ...
    <div v-if="loading" class="flex items-center justify-center min-h-screen">
      <div class="text-center">
        ...
        <p class="text-gray-600 text-lg">載入學習資源...</p>
      </div>
    </div>
    ...
    <div v-else class="max-w-6xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <div class="text-center">
          <h1 class="text-4xl font-bold text-gray-900 mb-4">學習資源中心</h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <div class="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 class="text-2xl font-bold text-gray-900">{{ cert.name }}</h2>
              <p class="text-sm text-gray-500">{{ cert.id === 'intermediate' ? 'Intermediate' : 'Elementary' }}</p>
            </div>
          </div>
      ...
      <div class="mt-12 bg-blue-50 border border-blue-200 rounded-xl p-6">
        <div class="flex items-start gap-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-blue-900 mb-2">學習資源說明</h3>
