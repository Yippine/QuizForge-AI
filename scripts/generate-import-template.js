...
const COLUMNS = [
  ...
  { field: 'source_type',   zh: '來源類型',   required: true,  width: 16,  hint: 'sample / exercise / ai / past' },
...
const REFERENCE_DATA = [
  ...
  ['sample', '官方樣題（官方發布，了解題型用）', '樣題/'],
  ['exercise', '講義習題（講義中輔助理解的練習）', '講義/'],
  ['ai', 'AI 試題（AI 生成，快速適應考場）', '非官方'],
  ['past', '歷屆試題（歷屆正式考場題目）', '歷屆考題/'],
  ['', '', ''],
  ['【答案 answer】', '', ''],
  ['值', '說明', ''],
  ['A', '選項A正確', ''],
